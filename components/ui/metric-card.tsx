...
export default function MetricCard({
  ...
  return (
    <Card
      className={cn(
        "group relative overflow-hidden border border-[#1F1F23] bg-[#131316] p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#3D4BFF]/50 hover:shadow-lg hover:shadow-[#3D4BFF]/10",
        className
      )}
    >
      ...
      <div className="flex items-center justify-between">
        ...
        {Icon && (
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-zinc-50 text-zinc-600 transition-all duration-300 group-hover:bg-rose-50 group-hover:text-rose-600 dark:bg-zinc-800/40 dark:text-zinc-400 dark:group-hover:bg-rose-950/30 dark:group-hover:text-rose-400">
      ...
      <div className="mt-4 flex items-baseline gap-2">
        <span className="text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50 md:text-3xl">
          {renderValue()}
        </span>
      </div>
      ...
      <div className="mt-3 flex items-center justify-between border-t border-zinc-100 pt-3 dark:border-zinc-800/60">
        ...
        {isZero && (
          <span className="flex items-center gap-1 rounded-full bg-zinc-50 px-2 py-0.5 text-[11px] font-bold text-zinc-400 dark:bg-zinc-900/60 dark:text-zinc-500">
